...
public class Reviews {
    ...
    public Reviews(int feedbackId, int userId, int overallRating, int caregiverRating, String comments,
                   Timestamp createdAt, Integer caregiverId, Integer productId,
                   String caregiverName, String productName) {
        this.feedbackId = feedbackId;
        this.userId = userId;
        this.overallRating = overallRating;
        this.caregiverRating = caregiverRating;
    ...
    // GET ONE (with names)
    public static Reviews getByIdWithNames(int feedbackId) throws SQLException {
        Connection conn = db.JDBC.connect();
    ...
    // UPDATE (owner check by user_id)
    public static boolean update(int feedbackId, int userId, int overallRating, int caregiverRating,
                                 String comments, int caregiverId, int productId) throws SQLException {
        Connection conn = db.JDBC.connect();
    ...
    // DROPDOWN: caregivers
    public static ArrayList<Option> getCaregiverOptions() throws SQLException {
        ArrayList<Option> list = new ArrayList<>();
        Connection conn = db.JDBC.connect();

        String sql = "SELECT caregiver_id, first_name, last_name FROM caregiver ORDER BY first_name";
    ...
    public static ArrayList<Option> getProductOptions() throws SQLException {
        ArrayList<Option> list = new ArrayList<>();
        Connection conn = db.JDBC.connect();
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                list.add(new Option(rs.getInt("product_id"), rs.getString("name")));
            }
        }
        return list;
    }
