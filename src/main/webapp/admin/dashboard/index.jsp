...
<head>
    ...
    <style>
        ...
        .sidebar h2 { margin: 0 0 30px 0; font-size: 24px; color: #1abc9c; }
        .sidebar a {
            display: block;
            padding: 14px 20px;
            color: #ecf0f1;
        ...
        .logout { margin-top: 60px; border-top: 1px solid #34495e; padding-top: 20px; }
        .logout a { background: #e74c3c !important; }
        .logout a:hover { background: #c0392b !important; }
...
<body>
    <div class="container">
        ...
        <div class="sidebar">
            <h2>Admin Panel</h2>
            <a href="adminDashboard.jsp" class="<%= request.getRequestURI().endsWith("adminDashboard.jsp") && request.getParameter("page") == null ? "active" : "" %>">Dashboard</a>
            <a href="adminDashboard.jsp?page=users" class="<%= "users".equals(request.getParameter("page")) ? "active" : "" %>">User Management</a>
            <a href="adminDashboard.jsp?page=orders" class="<%= "orders".equals(request.getParameter("page")) ? "active" : "" %>">Order Management</a>
            <a href="adminDashboard.jsp?page=services" class="<%= "services".equals(request.getParameter("page")) ? "active" : "" %>">Services Management</a>
            <a href="adminDashboard.jsp?page=feedback" class="<%= "feedback".equals(request.getParameter("page")) ? "active" : "" %>">Feedback Management</a>
            <div class="logout">
